...
import dev.claudiordgz.android.sliderlib.views.listeners.InternalViewPagerListener;
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            Pair<Integer, Integer> orientationAndWidth = OrientationHelper
                    .getScreenOrientationAndSize(getContext()).second;
            int width = orientationAndWidth.first / adapter.getCount();
