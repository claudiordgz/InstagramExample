...
public class ItemCard extends FrameLayout {
    ...
    public void init()
    {
        ...
        mTextViewLikeCount = (TextView) v.findViewById(R.id.count);
    ...
    private void pushText(){
        int fontSize = (int) DimensionConverter.pixelsToSp((float) (mWidth * (0.075)), getContext());
        fontSize = fontSize > 18 ? fontSize : 18;
        mTextViewLikeCount.setTextSize(TypedValue.COMPLEX_UNIT_SP, fontSize);
